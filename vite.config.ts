import { defineConfig, loadEnv } from 'vite' // Agregamos loadEnv
import react from '@vitejs/plugin-react'
import tailwindcss from '@tailwindcss/vite'
import path from 'node:path'

export default defineConfig(({ mode }) => {
  // Cargamos las variables del .env basado en el modo (development/production)
  // El tercer parámetro '' permite cargar variables que NO empiezan con VITE_
  ...
  return {
    ...
    define: {
      // Inyectamos las variables para que process.env funcione en el frontend
